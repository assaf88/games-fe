                        ...
                        <div key={`tokens-${player.id}`} style={{
                            ...
                            <div className='quest-team-token'
                                style={{  '--portrait-width': `${portraitWidth}px`,
                                    ...
                                    // left: 15,
                                    // left: '0.9vw',
                                    left: `${isVertical ? '1.5vw' : '0.9vw'}`, //increasing will take it left
                                    // top: `${isVertical ? '15' : '40'}`,
                                    top: `${isVertical ? '3.8vw' : '2.4vw'}`,//increasing will take it to circle center
                                    // top: 40
                                    // display: 'none'
                                }}>
                                {/*{!isVertical2 + " sdgf"}*/}
                            ...
                            <div id='result3' className='quest-decision-card'
                                 style={{ 
                                    '--portrait-width': `${portraitWidth}px` ,
                                    position: 'absolute',
                                    top: `${isVertical ? '27.5vw' : '15.5vw'}`, //increasing will shrink
                                    // top: '270px',
                                    zIndex: 5,
                                    display: `${isDeciding? 'inherit' : 'none'}`,
                                    visibility: `${isDeciding && hasDecided ? 'visible' : 'hidden'}`,
