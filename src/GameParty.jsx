                    ...
                    <div className="party-pre-game-start" style={{width: `${isVertical ? window.innerWidth : '100%'}`}}>
                        ...
                        {!gameState.gameStarted ? (
                            ...
                            <div style={{fontSize: '1.0rem'}}>
                                ...
                                <h3 style={{...((isVertical && gameState.players.length > 9 && isHost) ? {fontSize: '1.4rem', scale: '0.59', marginTop: '-1.25rem', paddingBottom: '1rem'} : {fontSize: '1.4rem', marginTop: `${isVertical ? '0' : '1rem'}`, scale: `${isVertical ? '0.9' : '1'}` })}}>
