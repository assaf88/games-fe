                    ...
                    <div className="party-pre-game-start" style={{width: `${isVertical ? window.innerWidth : '100%'}`}}>
                        ...
                        {!gameState.gameStarted ? (
                            ...
                            <div style={{fontSize: '1.0rem'}}>
                                ...
                                <div style={{}}>
                                <h3 style={{...((isVertical && gameState.players.length > 9 && isHost) ? {fontSize: '1.4rem', scale: '0.6', paddingBottom: '0.1rem'} : {fontSize: '1.4rem', marginTop: `${isVertical ? '0' : '0.5rem'}`, scale: `${isVertical ? '0.9' : '1'}` })}}>
