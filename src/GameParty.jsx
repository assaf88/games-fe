                        ...
                        {!gameState.gameStarted ? (
                            ...
                            <div style={{fontSize: '1.0rem'}}>
                                {rightAmountOfPlayers ? (
                                    <>
                                        {isHost ? (
                                        <div style={{display: 'flex', justifyContent: 'center', marginTop: `${isVertical ? '0.2rem' : '1.5rem'}`, scale: `${isVertical ? '0.88' : '1'}`}}>
                                ...
                                <h3 style={{...((isVertical && gameState.players.length > 9 && isHost) ? {fontSize: '1.4rem', scale: '0.55', marginTop: '-1.2rem', paddingBottom: '0.2rem'} : {fontSize: '1.4rem', marginTop: `${isVertical ? '0' : '1rem'}`, scale: `${isVertical ? '0.9' : '1'}` })}}>
